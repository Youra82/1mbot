...
# 1. Sichere secret.json (settings.json bleibt bewusst git-verwaltet, wie bei mbot)
...
# 8. Dauerhaften Prozess neu starten (kein Cron wie bei den anderen Bots --
#    1mbot laeuft als systemd-Service, siehe install.sh)
echo "8. Starte 1mbot-Service neu..."
sudo systemctl restart 1mbot.service

echo "Update erfolgreich abgeschlossen. 1mbot ist jetzt auf dem neuesten Stand."
